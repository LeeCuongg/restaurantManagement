...
| REPORT-02 | Cơ cấu doanh thu theo từng món | Xếp món theo TIỀN đóng góp (không theo số lượng — món rẻ bán nhiều dễ đứng đầu nhưng đóng góp ít), kèm % tỷ trọng và số phần. Hiện 20 món đầu, phần còn lại gộp "Món khác" tính bù từ tổng KPI nên Σ luôn đủ 100% | P4 | ◐ code+kiểm xong (0023 RPC; unit 30/30, e2e 6/6 trên tenant thật); chờ checkpoint |
